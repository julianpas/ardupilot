...
#define THISFIRMWARE "ArduPilotIMU V0.01"
/*
...
static const AP_Scheduler::Task scheduler_tasks[] PROGMEM = {
    //{ read_radio,             200,    700 }, // 0
    //{ check_short_failsafe,   200,   1000 },
    { ahrs_update,            4,   4000 }, //5400
    { update_speed_height,    5,   1600 },
    { update_flight_mode,     6,   1400 },
    { stabilize,              20,   3500 },
    //{ set_servos,             500,   1600 },
    //{ read_control_switch,    700,   1000 },
    { gcs_retry_deferred,     4,   1000 },
    { update_GPS,             20,   3700 },
    //{ navigate,               5,   3000 }, // 10
    { update_compass,         20,   1200 },
    //{ read_airspeed,          20,   1200 },
    { update_alt,             20,   3400 },
    { calc_altitude_error,    20,   1000 },
    { update_commands,        20,   5000 },
    //{ obc_fs_check,           5,   1000 },
    { gcs_update,             1,   100 }, //1700
    { gcs_data_stream_send,   1,   100 }, //3000
    //{ update_mount,           500,   1500 },
    { update_events,          100,   1500 }, // 20
    { check_usb_mux,          1000,    300 },
    //{ read_battery,           500,   1000 },
    { compass_accumulate,     5,   1500 },
    { barometer_accumulate,   4,    900 },
    { update_notify,          1,    300 },
    { one_second_loop,       200,   3900 },
    //{ check_long_failsafe,   2000,   1000 },
    { airspeed_ratio_update, 200,   1000 },
    //{ update_logging,         500,   1200 },
    //{ read_receiver_rssi,     200,   1000 },
};
*/
static const AP_Scheduler::Task scheduler_tasks[] PROGMEM = {
  { ahrs_update,            4,   1 }, //5400
  { update_speed_height,    5,   1 },
  { update_flight_mode,     6,   1 },
  { stabilize,              20,   1 },
  { gcs_retry_deferred,     4,   1 },
  { update_GPS,             20,   1 },
  { update_compass,         20,   1 },
  { update_alt,             20,   1 },
  { calc_altitude_error,    20,   1 },
  { update_commands,        20,   1 },
  { gcs_update,             1,   1 }, //1700
  { gcs_data_stream_send,   1,   1 }, //3000
  { update_events,          100,   1 }, // 20
  { check_usb_mux,          1000,    1 },
  { compass_accumulate,     5,   1 },
  { barometer_accumulate,   4,    1 },
  { update_notify,          1,    1 },
  { one_second_loop,       200,   1 },
  { airspeed_ratio_update, 200,   1 },
};
...
void loop()
{
    ...
    uint32_t remaining = (timer + 6000) - hal.scheduler->micros();
    if (remaining > 5900) {
        remaining = 5900;
    }
